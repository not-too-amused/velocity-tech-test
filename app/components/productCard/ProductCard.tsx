...
const ProductCard = ({ product }: { product: ProductFieldsFragment }) => {
    const initialVariant = product.variants.edges.length > 0 ? product.variants.edges[0].node.id : '';
    const [selectedVariant, setSelectedVariant] = useState(initialVariant);
    const [quantity, setQuantity] = useState<number>(0);
    const [cartLineId, setCartLineId] = useState<string>('');
    ...
    return (
        <div className="product__card">
                    ...
                    <div className="product__card-tag">
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                            <g clipPath="url(#clip0_318_307)">
                                <path d="M12.3203 0.534457H11.3416C11.293 0.229053 11.0362 0 10.7238 0H3.27615C2.97075 0 2.70699 0.229053 2.66534 0.534457H1.68666C0.756569 0.534457 0 1.28409 0 2.21418V3.27615C0 4.78929 1.2355 6.02479 2.74864 6.02479H3.00545C3.42885 7.03818 4.22013 7.84333 5.21963 8.30144L4.87258 10.6336C3.94943 10.6336 3.19286 11.3902 3.19286 12.3203V13.3823C3.19286 13.7224 3.4705 14 3.81061 14H10.1963C10.5364 14 10.8141 13.7224 10.8141 13.3823V12.3203C10.8141 11.3902 10.0575 10.6406 9.13436 10.6336L8.78037 8.30144C9.78681 7.84333 10.5711 7.03818 11.0015 6.02479H11.2583C12.7714 6.02479 14 4.78929 14 3.27615V2.21418C14 1.28409 13.2504 0.534457 12.3203 0.534457ZM1.68666 1.76996H2.6584V4.78235C1.86713 4.7407 1.2355 4.08131 1.2355 3.27615V2.21418C1.2355 1.97124 1.43679 1.76996 1.68666 1.76996ZM9.12742 11.8761C9.37729 11.8761 9.57858 12.0704 9.57858 12.3203V12.7645H4.42836V12.3203C4.42836 12.0704 4.62965 11.8761 4.87258 11.8761H9.12742ZM6.12196 10.6336L6.42043 8.64155C6.80912 8.69707 7.19782 8.69707 7.57957 8.64155L7.87804 10.6336H6.12196ZM10.1061 4.33813C10.1061 6.05255 8.71096 7.44769 7.00347 7.44769C5.29598 7.44769 3.90084 6.05255 3.90084 4.33813V1.2355H10.1061V4.33813ZM12.7645 3.27615C12.7645 4.08131 12.1329 4.7407 11.3416 4.78235V1.76996H12.3203C12.5632 1.76996 12.7645 1.97124 12.7645 2.21418V3.27615Z" fill="currentColor" />
                            </g>
                            <defs>
            ...
            <div className="product__card-si">
                <div className="product__card-si-quantity">
                    <button type="button" onClick={() => { }}>
                        Minus
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26" fill="none">
                            <path fillRule="evenodd" clipRule="evenodd" d="M8.25 14.5H18.75C19.164 14.5 19.5 14.164 19.5 13.75C19.5 13.336 19.164 13 18.75 13H8.25C7.836 13 7.5 13.336 7.5 13.75C7.5 14.164 7.836 14.5 8.25 14.5Z" fill="currentColor" />
                        </svg>
                    </button>
                    <span>{quantity}</span>
                    <button type="button" onClick={() => { }}>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="41" height="40" viewBox="0 0 41 40" fill="none">
                            ...
                            <path fillRule="evenodd" clipRule="evenodd" d="M21.3333 10.8333C21.3333 10.3731 20.9602 10 20.5 10C20.0398 10 19.6667 10.3731 19.6667 10.8333V19.1667H11.3333C10.8731 19.1667 10.5 19.5398 10.5 20C10.5 20.4602 10.8731 20.8333 11.3333 20.8333H19.6667L19.6667 29.1667C19.6667 29.6269 20.0398 30 20.5 30C20.9602 30 21.3333 29.6269 21.3333 29.1667L21.3333 20.8333H29.6667C30.1269 20.8333 30.5 20.4602 30.5 20C30.5 19.5398 30.1269 19.1667 29.6667 19.1667H21.3333L21.3333 10.8333Z" fill="currentColor" />
                        </svg>
                    </button>
                </div>
